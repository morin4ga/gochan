...
THREAD_BRUSHES = ThreadBrushes(Brush(Screen.COLOUR_WHITE, Screen.COLOUR_BLACK, Screen.A_NORMAL),
                               Brush(Screen.COLOUR_GREEN, Screen.COLOUR_BLACK, Screen.A_NORMAL),
